...
delta = 0.01
d = delta * S0 * math.exp(r / 360 * 180)
q = -math.log(1 - delta) / 360      # daily yield

print("European call")
parameter = {'S0': S0, 'K': K, 'T': T, 't': t, 'vol': vol, 'r': r, 'dividend': 0.01,
             "type": 'dividend yield', 'frequency': 252}  # annual dividend rate (compounded)
option = EuropeanOption.create(parameter)
print('BS price', option.PriceByBS(parameter))
...
print("European call with dividend yield : ", Price(EuropeanOption, parameter1, model))
print("Forward with dividend yield : ", Price(EuropeanOption, parameter11, model))
...
print("European call with discrete cash dividend: ", Price(EuropeanOption, parameter2, model))
print("Forward with discrete cash dividend: ", Price(EuropeanOption, parameter22, model))
...
print("European call with discrete proportional dividend: ", Price(EuropeanOption, parameter3, model))
print("Forward with discrete proportional dividend: ", Price(EuropeanOption, parameter33, model))
